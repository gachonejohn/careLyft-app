/*! careLyft 2.0.1 app.js
 * ======================
 * Main JS application file for careLyft v2. This file
 * should be included in all pages. It controls some layout
 * options and implements exclusive careLyft plugins.
 *
 ...
 */
if ("undefined" == typeof jQuery) throw new Error("careLyft requires jQuery");
($.careLyft = {}),
  ($.careLyft.options = {
    ...
    $.careLyft.layout.activate(),
      ...
      a.navbarMenuSlimscroll &&
        ...
        $(".navbar .menu")
          ...
          .css("width", "100%"),
      a.sidebarPushMenu && $.careLyft.pushMenu(a.sidebarToggleSelector),
      a.enableBSToppltip && $(a.BSTooltipSelector).tooltip(),
      a.enableBoxWidget && $.careLyft.boxWidget.activate(),
      a.enableFastclick &&
    ...
    fixSidebar: function () {
      return $("body").hasClass("fixed")
        ? ("undefined" == typeof $.fn.slimScroll &&
          ...
          void (
            $.careLyft.options.sidebarSlimScroll &&
            "undefined" != typeof $.fn.slimScroll &&
