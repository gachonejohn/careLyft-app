...
if (typeof jQuery === "undefined") {
  throw new Error("careLyft requires jQuery");
}
 ...
 *
 * @type Object
 * @description $.careLyft is the main object for the template's app.
 ...
 * - Implementation -
 * ------------------
 * The next block of code implements careLyft's
 * functions and plugins as specified by the
 * options above.
 */
$(function () {
  //Easy access to options
  var o = $.careLyft.options;

  //Activate the layout maker
  $.careLyft.layout.activate();

  //Enable sidebar tree view controls
  $.careLyft.tree(".sidebar");
  ...
  if (o.sidebarPushMenu) {
    $.careLyft.pushMenu(o.sidebarToggleSelector);
  }
 ...
 * - careLyft Functions -
 * ----------------------
 * All careLyft functions are implemented below.
 */
 ...
 *
 * @type Object
 * @usage $.careLyft.layout.activate()
 *        $.careLyft.layout.fix()
...
$.careLyft.layout = {
  ...
  fixSidebar: function () {
    ...
    if ($.careLyft.options.sidebarSlimScroll) {
      if (typeof $.fn.slimScroll != "undefined") {
 ...
 *
 * @type Function
 * @usage: $.careLyft.pushMenu("[data-toggle='offcanvas']")
 */
$.careLyft.pushMenu = function (toggleBtn) {
 ...
 *
 * @type Function
 * @Usage: $.careLyft.tree('.sidebar')
 */
$.careLyft.tree = function (menu) {
 ...
 *
 * @type Object
 * @usage $.careLyft.boxWidget.activate()
 *								Set all of your option in the main $.careLyft.options object
 */
$.careLyft.boxWidget = {
  activate: function () {
    var o = $.careLyft.options;
  ...
  options: $.careLyft.options.boxWidgetOptions,
};
